...
const appConfig = schema.validateSync(data)

appConfig.db.connection.uri = `${appConfig.db.client}://${appConfig.db.connection.host}:${appConfig.db.connection.port}`
appConfig.db.connection.uriDatabase = `${appConfig.db.connection.uri}/${appConfig.db.connection.database}`
